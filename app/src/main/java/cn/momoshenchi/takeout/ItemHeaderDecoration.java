...
public class ItemHeaderDecoration  extends RecyclerView.ItemDecoration
{
   ...
   public void setCheckListener(CheckListener checkListener) {
    ...
    public ItemHeaderDecoration(Context context, BeanGoods[] datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(BeanGoods[] mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    public void onDrawOver(Canvas canvas, final RecyclerView parent, RecyclerView.State state) {
        ...
        String tag = mDatas[pos].getTag();
        View child = parent.findViewHolderForLayoutPosition(pos).itemView;
        boolean isTranslate = false;//canvas是否平移的标志
        if (!TextUtils.equals(mDatas[pos].getTag(), mDatas[pos+1].getTag())
                || !TextUtils.equals(mDatas[pos].getTag(), mDatas[pos+2].getTag())
                || !TextUtils.equals(mDatas[pos].getTag(), mDatas[pos+3].getTag())
        ) {
            tag = mDatas[pos].getTag();
    ...
    private void drawHeader(RecyclerView parent, int pos, Canvas canvas) {
        ...
        tvTitle.setText(mDatas[pos].getTitlename());
